...
parser.add_argument('--dataroot', type=list, default=['../low_high_datasets/LOL/our485/'], help='root directory of the dataset')
parser.add_argument('--dataeval', type=list, default=['../low_high_datasets/LOL/eval15/'], help='root directory of the dataset')
...
result_dir = "./result_LOL/"
checkpoint_dir = "./output_LOL/"
result_test_dir = "./result_LOL/test"
